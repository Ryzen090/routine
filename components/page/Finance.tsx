    ...
    <div className="space-y-6 bg-white dark:bg-slate-950 min-h-screen pt-5 pb-20 px-4 transition-colors">
      <div className="max-w-md mx-auto space-y-6">
          ...
          <CardContent className="p-5 relative">
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-800 dark:text-slate-200 text-xs font-medium">
                  Total Balance
                </span>
                <Sparkles className="w-4 h-4 text-emerald-400" />
              </div>
              <div
                className={`text-3xl font-bold mb-2 ${balance >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-500 dark:text-red-400"}`}
              >
                ${balance.toFixed(2)}
              </div>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`text-xs px-2 py-1 rounded-full ${balance >= 0 ? "bg-emerald-500/20 text-emerald-600 dark:text-emerald-400" : "bg-red-500/20 text-red-500 dark:text-red-400"}`}
                >
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="text-xs font-medium text-red-600 dark:text-red-400">EXPENSES</div>
          ...
          <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="text-xs font-medium text-blue-600 dark:text-blue-400">TRADING</div>
                <div className="p-1.5 bg-blue-100 dark:bg-blue-950/60 rounded-lg">
                  <TrendingUp className="h-3 w-3 text-blue-600 dark:text-blue-400" />
                </div>
              </div>
              <div
                className={`text-xl font-bold mb-1 ${tradingAmount >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
              >
                ${tradingAmount.toFixed(2)}
              </div>
              <div className="text-xs text-gray-600 dark:text-slate-400">Trading P&L</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300">
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="p-1.5 bg-purple-100 dark:bg-purple-950/60 rounded-lg">
              ...
              <div className="text-xs text-gray-600 dark:text-slate-400">Savings rate</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="text-xs text-gray-600 dark:text-slate-400">Income vs Expenses</div>
              </div>
              <PieChart className="h-4 w-4 text-gray-400 dark:text-slate-500" />
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="border-t border-gray-100 dark:border-slate-800 pt-4 space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-slate-400">Net Cash Flow</span>
                <div
                  className={`text-sm font-bold ${balance >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
                >
                  ${balance.toFixed(2)}
                </div>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-slate-400">Trading Result</span>
                <div
                  className={`text-sm font-bold ${tradingAmount >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
                >
                  ${tradingAmount.toFixed(2)}
                </div>
              </div>
        ...
        <Card className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800 shadow-sm">
          <CardHeader className="pb-0">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div>
                  <CardTitle className="text-sm text-gray-900 dark:text-white">All Transactions</CardTitle>
                  <div className="text-xs text-gray-600 dark:text-slate-400">
                    Today&apos;s activity
                  </div>
                </div>
          ...
          <CardContent className="space-y-3 mt-4">
            {transactions
              ...
              .map((item) => (
                <div
                  ...
                  className="flex justify-between text-xs border-b border-gray-50 dark:border-slate-800/60 pb-2 last:border-0"
                >
                  <span className="text-gray-700 dark:text-slate-300 font-medium">{item.title}</span>
                  <span
            ...
            <div className="flex justify-between text-xs pt-2">
              <span className="text-gray-600 dark:text-slate-400">Savings Rate</span>
              <span
